# Bought - מערכת ניהול פיננסי חכמה
...
![WhatsApp](https://img.shields.io/badge/WhatsApp_Bot-25D366?style=flat&logo=whatsapp&logoColor=white)
...
- תמיכה במשתמשים מרובים עם הפרדת נתונים
...
- **ניהול טרנזקציות** - הוספה, עריכה ומחיקה של הוצאות והכנסות
